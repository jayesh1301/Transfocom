...
const onDataChange = (value, key, index) => {
  ...
  //     (row) => row.rates === "" || isNaN(parseFloat(row.rates))
  //   );
  ...
  //     inwardflag: 0,
  //     supplierid: supplier,
  //     indents: selectedItems, // Send only the selected items to the API
  //   };
  ...
  //     // Handle the parsed JSON data (success case)
  ...
  //     } else {
  //       // Handle other success cases or remaining items
  //       setRows(data.remainingItems);
  //     }
  //   } catch  {
